...
var common_ops = {
    ...
    data: {
        ...
        'prefix_url': $('.hidden_layout_wrap input[name=prefix_url]').val()                         //动态修改了 // 配置文件获取/ 而外部的访问  html只需要前缀简称-获得上传文件夹；因为拦截器的功效
    },
    ...
    buildPicUrl: function( img_key ){
        ...
        return this.data['domain'] + this.data['prefix_url'] + img_key ;
    }
