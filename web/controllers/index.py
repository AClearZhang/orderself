...
from flask import Blueprint
from common.libs.Helper import ops_render
from common.libs.Helper import getFormatDate                    # 新增
from common.models.stat.StatDailySite import StatDailySite      # 新增
import datetime
route_index = Blueprint( 'index_page',__name__ )

# 仪表盘
'''
    互联网的展示  通过我们电脑的内存进行计算

    因为：数据库 擅长的是 存储 和 搜索，而不是计算
